...
/*
	This implementation uses object-based isolations.
**/

public class BankTransactionsUsingObjectBasedIsolation {
	private static Random random = new Random();
	private static final int MAX_RANDOM_BALANCE = 1000;

	public static void main(final String[] args) {
		System.out.println("\t*BANK-TRANSACTIONS-OBJECT-BASED*");
		...
		BankTransactionsUsingObjectBasedIsolation app = new BankTransactionsUsingObjectBasedIsolation(numAccounts, numTransactions, maxNumThreads, accounts);
	}

	public BankTransactionsUsingObjectBasedIsolation(int numAccounts, int numTransactions, int maxNumThreads, final Account[] accounts) {
		System.out.printf("Time taken in OBJECT-BASED ISOLATIONS:\n");
		// execute the tasks.
	...
	private void process(int transactionId, int numAccounts, Account[] accounts) {
		...
		// Isolate the 2 objects only, this will optimize the parallelism.
		PCDP.isolated(srcAccount, destAccount, () -> {
